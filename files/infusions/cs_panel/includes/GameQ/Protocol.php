...
abstract class Protocol
{
    ...
    protected $normalize = array(
        ...
        'general' => array(
            ...
            'maxplayers' => array('svmaxclients', 'simaxplayers', 'maxclients', 'max_players'),
            'mod'        => array('game', 'gamedir', 'gamevariant'),
            'numplayers' => array('clients', 'sinumplayers', 'num_players'),
            'password'   => array('protected', 'siusepass', 'sineedpass', 'pswrd', 'gneedpass', 'auth', 'passsord'),
        ),
        // Indvidual
        'player'  => array(
